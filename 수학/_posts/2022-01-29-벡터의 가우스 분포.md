...
(3) \\(\mathbf{\Sigma} = \begin{bmatrix} \mathbf{\Sigma}_ {a, a} &  \mathbf{\Sigma}_{a, b}  \\  \mathbf{\Sigma} _{b, a} &  \mathbf{\Sigma} _{b, b}  \end{bmatrix}\\) (단, \\( \mathbf{\Sigma} _{a, a} \\)는 \\(M \times M\\) 행렬, \\( \mathbf{\Sigma} _{a, b} \\)는 \\(M \times (D-M)\\) 행렬, \\( \mathbf{\Sigma} _{b, a} \\)는 \\((D-M) \times M\\) 행렬, \\( \mathbf{\Sigma} _{b, b} \\)는 \\((D-M) \times (D-M)\\) 행렬)
