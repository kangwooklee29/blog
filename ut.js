parcelRequire = function(e)
{
	...
	return u.register = function(e,r){i[e]=r},i=e(u),u.modules=i,u
} ( function (require) 
    {
	    var d={};
		function l(e){
		    for(var r,o=/\+/g,n=/([^&=]+)=?([^&]*)/g,p=function(e){return decodeURIComponent(e.replace(o," "))},a={}; r = n.exec(e);)
			    a[p(r[1])]=p(r[2]);
			return a
		}
		function g(e)
		...
		void 0===c&&(c=document.querySelector("script[src^=\"https://utteranc.es/client.js\"],
		...
		b.url = u?u.href:location.origin+location.pathname+location.search, 
		b.origin = location.origin, 
		b.pathname = location.pathname.length<2?"index":location.pathname.substr(1).replace(/\.\w+$/,""), 
		...
		b["og:title"] = x?x.content:"", 
		b.session = i||localStorage.getItem("utterances-session")||"",
		...
		var y = c.src.match(/^https:\/\/utteranc\.es|http:\/\/localhost:\d+/)[0],
		    z = y + "/utterances.html";
		alert(z+"?"+g(b));
		...
		addEventListener("message",function(t){if(t.origin===y){var r=t.data;r&&"resize"===r.type&&r.height&&(A.style.height=r.height+"px")}});
